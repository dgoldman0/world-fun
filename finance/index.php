<html>
  <head>
	...
	<meta name="twitter:description" content="World Builder Financial Console" />
   </head>
   <body>
    <?php require_once('inc/menu_bar.php'); ?>
   	<div id = "main">
   		<div class = row>
   			<div class = "col-md-3">
   				<h1><center>Wallet Console</center></h1>
   			</div>
   			<div class = "col-md-9">
   				Tron and other blockchains decentralize finance, but there are some nice things that centralized services have, such as being able to easily keep track of transaction history. World Builder Finance is a project to create a suite of financial tools for crypto. There's still a lot to work out in terms of design, including whether the service should be completely free, or if it should be a pay for use. If it's a paid service, it will be a paid software as a service platform that charges WRLD for use.
   			</div>
   		</div>
   	</div>
   </body>
