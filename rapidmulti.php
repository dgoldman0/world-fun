<html>
	<head>
	    ...
	    <script src="/js/rapidmulti.js"></script>
	</head>
	<body>
    ...
    <div id = "main" class = "row">
      <div id = "status_bar" class = "col-md-3">
        ...
        <div class="float-right"><span id="first-burn"></span> WRLD</div>
        <div class="clearfix"></div>
      ...
      <hr/>
	    <div class = "disclaimer">
	    	<p class = "lead">Burner is an economic game. To learn more, check out <a href = "/burner_details.php">the game details page</a>. There are no refunds. 5% of the registration fee goes to the devs, and if you were referred by someone then 5% goes to that referrer. 50% of the contract balance is given for the prize at the end of each round. This game is a rapid fire version which lasts for a much shorter period of time. The game will not start until there are at least five people registered for the round.
	    </div>
	</body>
</html>
