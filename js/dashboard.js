...
$(document).ready(function() {
	...
	contracts.waterfall = tronWebGlobal.contract(abi_waterfall, 'TRYcXPKBQNrNfTW7eZT51oBQJjasNJWvru');
	contracts.burner = tronWebGlobal.contract(abi_burner, 'TDrCRUoXCKC4mJ1iG76nhopFzYenT9zRvC');
