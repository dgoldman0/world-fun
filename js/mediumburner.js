var contractAddress = 'TEsuZqjafyCrQHNtwrBVmrEMJjGC7cUrU7';
const TID = 1002567;
...
$(document).ready(function() {
	$("#register").click(function() {
	  if (checkConnection()) {
	    var contract = window.tronWeb.contract(abi_med, contractAddress);
	...
	var contractGlobal = tronWebGlobal.contract(abi_med, contractAddress);
	...
	var run = function() {
		...
		contractGlobal.regBonus().call().then(function (res) {
			$('#reg-bonus').text(res / 1000000);
		});
