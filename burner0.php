      ...
      <div id = "status_bar" class = "col-md-3">
		...
		<div>
	        ...
	        <form>
		        ...
		        <button type = "button" class = "btn btn-primary" id = "burn">Burn WLRD</button> <button type = "button" class = "btn btn-primary" id = "register">Register (<span id = "buy-in"></span>TRX Fee)</button>	
		    </form>
		</div>
      </div>
    </div>
