<html>
	<head>
	    ...
	    <script src="/js/mediumburner.js"></script>
	</head>
	<body>
    ...
    <div id = "main" class = "row">
      <div id = "status_bar" class = "col-md-3">
        ...
        <div class="float-left">Registration Bonus:</div>
        <div class="float-right"><span id="reg-bonus"></span> WRLD</div>
        <div class="clearfix"></div>
      ...
      <div id = "ad" class = "col-md-5">
      	...
      	<p>Burners are a set of economic auction games. You "battle" with other users by burning WRLD. The person who burns the most WRLD at the end of the game wins the prize pool. You can get WRLD from the <a href = "https://worldbuilder.fun/faucet.php">faucet</a>, or you can buy it through <a href="https://tronwatch.market/trade/1002567-TRX">Tronwatch's DEX</a>.</p>
      	<p>This version of the burner is a medium length game that lasts for 12 hours. It starts once 10 people register, and gives a registration bonus in WRLD. The earlier you register in the round, the bigger the bonus will be. Realize that blockchain often suffers from a slight delay, so the registration bonus may be less than what is listed, because another reigstration is already pending. That's why it's important to register as soon as possible.</p>
      	<hr/>
